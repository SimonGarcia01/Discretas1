...
public class AVLtree<T extends Comparable<T>>{
    ...
    public String preOrder(){
        ...
        if(root == null){
            ...
            message = preOrder(root, message);
        }

        return message;
    }

    private String preOrder(Node<T> current, String message){
        ...
        if(current == null){
            ...
            //Check method
            message += "("+current.getValue()+","+current.getBalancingFactor()+") " + preOrder(current.getLeft(), message) + preOrder(current.getRight(), message);
        }
